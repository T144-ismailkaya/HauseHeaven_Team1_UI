...
public class TC_L012footerHouseforRent {
    @Test
    public void TC012 (){
            ...
            //Ziyaretci footer bolumunde yer alan "Houses for Rent" tab'ina tiklar
            homePage.sefFooterHouseForRentElementi.click();
            //Ziyaretci ayni sekmede "Houses for Rent" sayfasinin acildigini kontrol eder
            int winHandleTimes = 1;
            Assert.assertEquals(Driver.getDriver().getWindowHandles().size(), winHandleTimes);
            //Ziyaretci "Houses for Rent" sayfasinda asagiya footer bolumune scroll yapar
            ReusableMethods.hover(homePage.SefFooterElementi);
            ...
            //Ziyaretci halen  "Houses for Rent sayfasinda oldgunu dogrular
